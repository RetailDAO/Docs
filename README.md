...
### Meet Our Token: $RETAIL :coin:

An ERC-20 standard token deployed on Base Network with 1B supply.
...
3. **Get $RETAIL Tokens**: We post regularly on our socials quests and dynamics to earn $RETAIL :coin: tokens, also we are planning our 2nd major Airdrop so be sure to engage with the community or you can simply purchase $RETAIL :coin: tokens on [supported exchanges](https://app.uniswap.org/explore/tokens/base/0xc7167e360bD63696a7870C0Ef66939E882249F20), to get access to premium token gated channels and chats with more features to unlock.

4. **Participate**: Engage with our bounty programs and QuestN tasks, Create proposals, Vote on proposals, or contribute to earn even more rewards.
